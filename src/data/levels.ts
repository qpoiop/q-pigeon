...
/** Attack-zone shape: radial = circle AoE around the guard; line = a long strike ahead. */
export type GuardType = 'radial' | 'line';
...
export const LEVELS: LevelDef[] = [
  {
    ...
    d: 58,
    brief:
      '외곽 감시 시설. 적 경비를 전원 제압하라. 청록색 은폐 구역을 활용할 것.',
    spawn: [0, 17],
    extract: [0, -17, 5, 3.5],
    walls: [
      { x: -15, z: 8, w: 14, d: 1.4 },
      ...
      { x: -4, z: -5, w: 6, d: 1.4 },
      { x: 7, z: -4, w: 1.4, d: 6 },
      // outer maze filling the enlarged margins (short spurs → free space stays connected)
      { x: -34, z: 20, w: 8, d: 1.4 },
      { x: 34, z: 20, w: 8, d: 1.4 },
      { x: -34, z: -20, w: 8, d: 1.4 },
      { x: 34, z: -20, w: 8, d: 1.4 },
    ...
    guards: [
      ...
      { path: [[-38, 26], [38, 26]], speed: 2.2, range: 8, type: 'radial' },
      { path: [[38, -26], [-38, -26]], speed: 2.2, range: 8, type: 'line' },
      { path: [[-38, 0], [-38, 26]], speed: 2.0, range: 8 },
      { path: [[38, 0], [38, -26]], speed: 2.0, range: 8 },
    ],
  },
  {
    ...
    w: 104,
    d: 68,
    brief: '거대한 서고. 겹치는 순찰선을 뚫고 경비를 전원 제압하라.',
    spawn: [-34, 21],
    extract: [34, -21, 5, 4],
    ...
    walls: [
      ...
      { x: 19, z: -17, w: 30, d: 1.4 },
      { x: -42, z: 12, w: 1.4, d: 16 },
      { x: 42, z: 12, w: 1.4, d: 16 },
      { x: -42, z: -12, w: 1.4, d: 16 },
      { x: 42, z: -12, w: 1.4, d: 16 },
      { x: -20, z: 28, w: 14, d: 1.4 },
      { x: 20, z: 28, w: 14, d: 1.4 },
      { x: -20, z: -28, w: 14, d: 1.4 },
      { x: 20, z: -28, w: 14, d: 1.4 },
    ],
    ...
    guards: [
      ...
      { path: [[-46, 30], [46, 30]], speed: 2.3, range: 8.5, type: 'radial' },
      { path: [[46, -30], [-46, -30]], speed: 2.3, range: 8.5, type: 'line' },
      { path: [[-46, 30], [-46, -30]], speed: 2.2, range: 8.5 },
      { path: [[46, -30], [46, 30]], speed: 2.2, range: 8.5 },
    ],
  },
  {
    ...
    w: 120,
    d: 82,
    brief: '심장부다. 빠른 순찰과 넓은 시야. 경비를 전원 제압하라.',
    spawn: [0, 26],
    extract: [0, -26, 6, 4],
    ...
    walls: [
      ...
      { x: -28, z: -15, w: 22, d: 1.4 },
      { x: 28, z: -15, w: 22, d: 1.4 },
      { x: -50, z: 15, w: 1.4, d: 20 },
      { x: 50, z: 15, w: 1.4, d: 20 },
      { x: -50, z: -15, w: 1.4, d: 20 },
      { x: 50, z: -15, w: 1.4, d: 20 },
      { x: -25, z: 34, w: 16, d: 1.4 },
      { x: 25, z: 34, w: 16, d: 1.4 },
      { x: -25, z: -34, w: 16, d: 1.4 },
      { x: 25, z: -34, w: 16, d: 1.4 },
    ],
    ...
    guards: [
      ...
      { path: [[-40, 20], [-40, -20]], speed: 2.6, range: 9, type: 'line' },
      ...
      { path: [[-55, 36], [55, 36]], speed: 2.6, range: 9, type: 'line' },
      { path: [[55, -36], [-55, -36]], speed: 2.6, range: 9, type: 'radial' },
      { path: [[-55, 36], [-55, -36]], speed: 2.5, range: 9 },
      { path: [[55, 36], [55, -36]], speed: 2.5, range: 9 },
    ],
  },
  {
